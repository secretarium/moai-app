        ...
        <MainLayout goBackRoute={'/'} showGoBack={true} withNavigation={true}>
            <View style={{
                ...
                <Text style={{ fontFamily: 'Poppins-Regular', color: themeTextStyle }}>
                    Moai gathers information securely via a short survey to measure factors that affect the spread of COVID-19. Developed by Secretarium, a deep-tech startup founded in 2016 with the aim of building useful technology that never compromises anyone’s privacy.{'\n'}{'\n'}
